...
const CardCartNav = () => {
  return (
    <article className='cart-modal container' style={{position: 'absolute', width: '320px', userSelect: 'none'}}>
      <h3 className='pb-2 mt-2' style={{ fontSize: '1.5rem', borderBottom: 'solid #bbb 1px' }}>Cart</h3>
